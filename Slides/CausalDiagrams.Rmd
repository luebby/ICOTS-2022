...
- .purple[*Bias*]: Systematic difference between estimate and estimand.
...
- Two instructors, seven tatistics-related courses for non-majors.
...
- Statistical discernible positive effect ($p-value=0.0012$, Cohen's $h=0.26$).

- Limitations: Oobservational study within the classes.
